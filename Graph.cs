...
public class Graph
{
    ...
    private List<Station>? graph;

    
    public async Task<List<Station>> BuildGraphAsync()
    {
        ...
        return graph ?? throw new Exception("Failed to build graph");
    }
    ...
    private void BuildGraph()
    {
        ...
        {
            Station? station1 = stations.Find(s => s.NameEn == line1Stations[i][0]);
            if (station1 is null)
            {
                station1 = new(
                    line1Stations[i][0],
            ...
            Station? station2 = stations.Find(s => s.NameEn == line1Stations[i + 1][0]);
            if (station2 is null)
            {
                station2 = new(
                    line1Stations[i + 1][0],
        ...
        {
            Station? station1 = stations.Find(s => s.NameEn == line2Stations[i][0]);
            if (station1 is null)
            {
                station1 = new(
                    line2Stations[i][0],
            ...
            Station? station2 = stations.Find(s => s.NameEn == line2Stations[i + 1][0]);
            if (station2 is null)
            {
                station2 = new(
                    line2Stations[i + 1][0],
        ...
        {
            Station? station1 = stations.Find(s => s.NameEn == line3Stations[i][0]);
            if (station1 is null)
            {
                station1 = new(
                    line3Stations[i][0],
            ...
            Station? station2 = stations.Find(s => s.NameEn == line3Stations[i + 1][0]);
            if (station2 is null)
            {
                station2 = new(
                    line3Stations[i + 1][0],
        ...
        {
            Station? station1 = stations.Find(s => s.NameEn == line3HarounExt[i][0]);
            if (station1 is null)
            {
                station1 = new(
                    line3HarounExt[i][0],
            ...
            Station? station2 = stations.Find(s => s.NameEn == line3HarounExt[i + 1][0]);
            if (station2 is null)
            {
                station2 = new(
        ...
        {
            Station? station1 = stations.Find(s => s.NameEn == line3KitKatExt[i][0]);
            if (station1 is null)
            {
                station1 = new(
                    line3KitKatExt[i][0],
            ...
            Station? station2 = stations.Find(s => s.NameEn == line3KitKatExt[i + 1][0]);
            if (station2 is null)
            {
                station2 = new(
